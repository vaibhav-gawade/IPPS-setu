...
export default function PilotsPage() {
  ...
  const pilots = [
    { id: 'PLT-1029', title: 'AI Surveillance Drone Testing', status: 'Active', progress: 60, nextMilestone: 'Field Test 2 on Oct 15' },
    { id: 'PLT-1045', title: 'Secure Comms Protocol', status: 'Upcoming', progress: 0, nextMilestone: 'Kickoff meeting on Nov 1' },
    { id: 'PLT-0998', title: 'Autonomous Supply Vehicle', status: 'Completed', progress: 100, nextMilestone: 'Final Report Submitted' }
  ];
      ...
      <div style={{ display: 'grid', gap: '16px' }}>
        {displayed.length === 0 ? (
          <div className="empty-state">
            ...
            <p>You do not have any {tab.toLowerCase()} pilots at the moment.</p>
          </div>
        ) : (
          displayed.map(pilot => (
